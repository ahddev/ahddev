...
<main className="flex flex-col gap-[32px] row-start-2 items-center sm:items-start">
    <div className="animate-fade-down animate-ease-out text-4xl font-bold">
        ...
        <div className='w-full md:w-[26rem] h-full hover:underline cursor-pointer border-2 rounded-2xl p-4  shadow-md hover:shadow-lg transition-all  duration-300 hover:bg-foreground/10 hover:scale-105' onClick={() => window.open('https://labak-sy.com', '_blank')}>
                <Image src="/labak-sy.png" alt="labak-sy.store" width={200} height={200} className='w-full h-full object-cover' />
                <h2 className='mt-4 text-2xl font-bold flex items-center gap-2'>Labak-sy <ExternalLink className='w-4 h-4' /></h2>
            </div>
            <div className='w-full md:w-[26rem] h-full hover:underline cursor-pointer border-2 rounded-2xl p-4  shadow-md hover:shadow-lg transition-all  duration-300 hover:bg-foreground/10 hover:scale-105' onClick={() => window.open('https://razio.store', '_blank')}>
                <Image src="/razio.png" alt="Razio.store" width={200} height={200} className='w-full h-full object-cover' />
            ...
            <div className='w-full h-full md:w-[26rem] hover:underline cursor-pointer border-2 p-4 rounded-2xl shadow-md hover:shadow-lg transition-all  duration-300 hover:bg-foreground/10 hover:scale-105' onClick={() => window.open('https://iust.ir', '_blank')}>
                <Image src="/iust.png" alt="IUST Lecture Materials" width={200} height={200} className='w-full h-full object-cover' />
